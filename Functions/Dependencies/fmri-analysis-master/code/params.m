...
switch type
    ...
    case 'rootdir'
        ...
        elseif strfind(x, '/Users/agnes.land/Documents/PhD/MatlabFonctions/');
            y = '/Users/agnes.land/Documents/PhD/MatlabFonctions/';
        elseif strfind(x, [code_path 'Functions/Dependencies/']);
            y = [code_path 'Functions/Dependencies/'];
        else
